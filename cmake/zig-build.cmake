...
set(INCLUDE_DIRS
    "/home/linux/.espressif/tools/xtensa-esp-elf/esp-15.1.0_20250607/xtensa-esp-elf/picolibc/include/sys"
    "/home/linux/.espressif/tools/xtensa-esp-elf/esp-15.1.0_20250607/xtensa-esp-elf/xtensa-esp-elf/include/"
    ...
    "${IDF_PATH}/components/cmock/CMock/src"
    ...
    "${IDF_PATH}/components/esp-tls/esp-tls-crypto"
...
set(DEFINE_FLAGS
    ...
    "-DXCHAL_HAVE_LOOPS=1"
    "-DXCHAL_NUM_AREGS=64"
    "-DXCHAL_HAVE_WINDOWED=0"     # uses CALL0 ABI, no windowed registers
    "-DXCHAL_HAVE_FP=1"
    "-DXCHAL_HAVE_DPFPU=1"
    "-DXCHAL_HAVE_DPFPU_SINGLE_ONLY=1")
...
# Define the full C++ exception support static library
#add_library(esp_cxx_exception_support STATIC
#    ${IDF_PATH}/components/cxx/cxx_exception_stubs.cpp
#    ${IDF_PATH}/components/cxx/cxx_guards.cpp
#    ${IDF_PATH}/components/cxx/cxx_init.cpp
#)

# Add necessary compile flags for exception support
#target_compile_options(esp_cxx_exception_support PRIVATE -fexceptions -fno-rtti)
#target_include_directories(esp_cxx_exception_support PUBLIC ${IDF_PATH}/components/cxx)
...
# Link it into the component build (which produces the final ELF)
# target_link_libraries(${COMPONENT_LIB} PRIVATE esp_cxx_exception_support)
...
target_link_libraries(${COMPONENT_LIB} PRIVATE
    "-Wl,--start-group"
    "/home/linux/.espressif/tools/xtensa-esp-elf/esp-15.1.0_20250607/xtensa-esp-elf/xtensa-esp-elf/lib/esp32/no-rtti/libstdc++.a"
    # "-Wl,--whole-archive"
    #${CMAKE_BINARY_DIR}/esp-idf/cxx/libcxx.a


    # Link C++ exception stubs (cxx)
    # ${CMAKE_BINARY_DIR}/esp-idf/cxx/libcxx.a

    # ESP-IDF core + net + WiFi libs
    ...
    "${IDF_PATH}/components/esp_wifi/lib/${TARGET_IDF_MODEL}/libnet80211.a"
    "${IDF_PATH}/components/esp_wifi/lib/${TARGET_IDF_MODEL}/libpp.a"
    "${IDF_PATH}/components/esp_wifi/lib/${TARGET_IDF_MODEL}/libespnow.a"
    "${IDF_PATH}/components/esp_wifi/lib/${TARGET_IDF_MODEL}/libsmartconfig.a"
    "${IDF_PATH}/components/esp_wifi/lib/${TARGET_IDF_MODEL}/libwapi.a"
    #"-Wl,--no-whole-archive"
    

    # Support + HAL
    "${IDF_PATH}/components/xtensa/esp32/libxt_hal.a"
    "${CMAKE_BINARY_DIR}/esp-idf/esp_common/libesp_common.a"
